...
function Header(){
    ...
    return (
        <HeaderWrapper $colorTheme={colorTheme}>
            <HeaderFixed $colorTheme={colorTheme}>
                <div className="content_large">
                    ...
                    <Menu>
                        ...
                        <ColorThemeSwitch $colorTheme={colorTheme}>
                            <ColorTheme $colorTheme={colorTheme} onClick={setDayTheme} className={colorTheme === "Day" && "active"}>
                            ...
                            <ColorTheme $colorTheme={colorTheme} onClick={setNightTheme} className={colorTheme === "Night" && "active"}>
