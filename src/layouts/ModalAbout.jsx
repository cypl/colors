...
const content = {
    text: 
        ["NanoColors permet de générer une gamme de couleur à partir d'une couleur de départ. Cette gamme peut ensuite être utilisée pour créer le webdesign d'un Nanosite, ou bien être exportée sous la forme d'un objet javascript ou d'une liste de variables SASS pour être utilisée directement par un développeur.",
